...
var ErrInvalidWithvarFormat = errors.New("invalid runtime format")

type Withvar int32

func (r Withvar) MarshalJSON() ([]byte, error) {
	jsonValue := fmt.Sprintf("%d variables", r)
	quotedJSONValue := strconv.Quote(jsonValue)
	return []byte(quotedJSONValue), nil
}
func (r *Withvar) UnmarshalJSON(jsonValue []byte) error {
